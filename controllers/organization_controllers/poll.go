...
func CreatePoll(c *fiber.Ctx) error {
	...
	go routines.MarkOrganizationHistory(orgID, parsedUserID, 18, nil, nil, nil, nil, nil, &poll.ID, nil, nil, nil, nil, "")
...
func EditPoll(c *fiber.Ctx) error {
	...
	go routines.MarkOrganizationHistory(orgID, parsedUserID, 20, nil, nil, nil, nil, nil, &poll.ID, nil, nil, nil, nil, "")
...
func DeletePoll(c *fiber.Ctx) error {
	...
	go routines.MarkOrganizationHistory(orgID, parsedUserID, 19, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, poll.Content)
