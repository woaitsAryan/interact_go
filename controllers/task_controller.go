...
func AddTask(taskType string) func(c *fiber.Ctx) error {
	return func(c *fiber.Ctx) error {
		...
		case "org_task":
			...
			go routines.MarkOrganizationHistory(parsedOrgID, parsedOrgMemberID, 12, nil, nil, nil, &task.ID, nil, nil, "")
	...
	return func(c *fiber.Ctx) error {
		...
		case "task":
			...
			if orgMemberID != "" && orgID != "" {
				...
				go routines.MarkOrganizationHistory(parsedOrgID, parsedOrgMemberID, 13, nil, nil, nil, nil, nil, nil, task.Title)
			}
