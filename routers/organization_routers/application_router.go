...
func OrgApplicationRouter(app *fiber.App) {
	...
	applicationRoutes.Get("/:applicationID", middlewares.OrgRoleAuthorization(models.Manager), organization_controllers.GetApplication)
	...
	applicationRoutes.Post("/:openingID", organization_controllers.AddApplication)

	applicationRoutes.Delete("/:applicationID", organization_controllers.DeleteApplication)
}
